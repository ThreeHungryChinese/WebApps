...
namespace MaineCoon.Pages.Callback
{
    ...
    [ApiController]
    public class QuestRecordsController : ControllerBase
    {
        private readonly MaineCoonContext _context;

        public QuestRecordsController(MaineCoonContext context)
        {
            _context = context;
        }

        // GET: api/QuestRecords
        [HttpGet]
